 ...
 * @author donih
 */
public class EditPoli extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MenuPoli/Asset/BGEdit.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditPoli.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
